            ...
            @foreach ($employees as $employee)
                <div class="col-lg-4">
                    <div class="team-member">
                        ...
                        <a class="btn btn-dark btn-social mx-2" href="{{$employee->profile->twitter_url}}"><i class="fab fa-twitter"></i></a>
                        <a class="btn btn-dark btn-social mx-2" href="{{$employee->profile->facebook_url}}"><i class="fab fa-facebook-f"></i></a>
                        <a class="btn btn-dark btn-social mx-2" href="{{$employee->profile->instagram_url}}"><i class="fab fa-linkedin-in"></i></a>
                    </div>
                </div>
            @endforeach
